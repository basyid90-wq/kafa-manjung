    ...
    <div style="max-width:72rem;margin:0 auto;padding:2rem 1rem 3rem;">
        ...
        <div style="max-width:480px;margin:0 auto 1.5rem;">
            ...
            <div style="background:#fff;border-radius:1.25rem;overflow:hidden;
                ...
                {{-- ── Flowbite Tabs with icons — full width ── --}}
                ...
                <div style="padding:1.5rem;">
                    ...
                    <x-auth-session-status class="mb-4" :status="session('status')" />
                        ...
                        <p style="text-align:center;font-size:0.8rem;color:#9ca3af;margin-top:1rem;">
                            ...
                            <a href="https://wa.me/60194920559?text=Saya%20perlu%20bantuan%20log%20masuk%20APKM"
                               target="_blank" rel="noopener"
                               style="font-weight:600;color:#25d366;text-decoration:none;display:inline-flex;align-items:center;gap:4px;">
                            ...
                            <div class="flex-1 min-w-0">
                                ...
                                <button type="button" onclick="showAnnouncementModal({{ $ann->id }})"
                                        style="font-size:0.82rem;font-weight:600;color:#1a56db;border:none;
                                               background:none;cursor:pointer;padding:5px 0 0;text-decoration:none;">
                                    Baca selanjutnya →
                                </button>
                                @endif
                            </div>
