                ...
                <div class="rbt-dashboard-content bg-color-white rbt-shadow-box">
                    <div class="content">
                        <div class="section-title">
                            <h4 class="rbt-title-style-3">Tambah Pengguna</h4>
                        </div>

                        <form action="{{ route('users.store') }}" method="POST" class="rbt-profile-row rbt-default-form row row--15">
                            @csrf
                                    ...
                                    <div class="row g-2">
                                        ...
                                        <div class="col-lg-3 col-md-4 col-sm-6">
                                            <div class="form-check p-0 m-0 d-flex align-items-center">
                                                <input class="form-check-input m-0 me-2" type="checkbox" name="roles[]" value="{{ $role->name }}" id="role_{{ $role->id }}" style="width: 18px; height: 18px; cursor: pointer;">
                            ...
                            <div class="col-12 mt--30">
                                <div class="rbt-button-group">
                                    <button class="rbt-btn btn-gradient" type="submit">Simpan Pengguna</button>
