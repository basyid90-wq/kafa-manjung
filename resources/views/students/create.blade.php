                ...
                <div class="rbt-dashboard-content bg-color-white rbt-shadow-box">
                    <div class="content">
                        <div class="section-title">
                            <h4 class="rbt-title-style-3">Tambah Murid Baru</h4>
                        </div>

                        <form action="{{ route('students.store') }}" method="POST" enctype="multipart/form-data" class="rbt-default-form" id="wizard-form">
                            @csrf
                                    ...
                                    <div class="row row--15">
                                        <div class="col-md-4 offset-md-4 mb--20 text-center">
                                            <div class="rbt-form-group">
                                                <label for="profile_picture">Gambar Pelajar</label>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="rbt-form-group">
                                                ...
                                                <input id="mykid" name="mykid" type="text" value="{{ old('mykid') }}" placeholder="Contoh: 150523081234" required>
                                            </div>
                                        </div>
                                        <div class="col-lg-3">
                                            <div class="rbt-form-group">
                                                <label for="dob">Tarikh Lahir</label>
                                                <input id="dob" name="dob" type="date" value="{{ old('dob') }}" readonly>
                                            </div>
                                        </div>
                                        <div class="col-lg-3">
                                            <div class="rbt-form-group">
                                                <label for="age">Umur</label>
                                                <input id="age" name="age" type="number" value="{{ old('age') }}" readonly>
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                                            <div class="rbt-form-group">
                                        ...
                                        <div class="col-lg-4">
                                            <div class="rbt-form-group">
                                                ...
                                                <input id="race" name="race" type="text" value="{{ old('race') }}">
                                            </div>
                                        </div>
                                        <div class="col-lg-4">
                                            <div class="rbt-form-group">
                                                <label for="citizenship">Warganegara</label>
                                                <input id="citizenship" name="citizenship" type="text" value="{{ old('citizenship') }}">
                                            </div>
                                        </div>
                                        <div class="col-lg-4">
                                            <div class="rbt-form-group">
                                                <label for="oku_status">Status OKU</label>
                                                <input id="oku_status" name="oku_status" type="text" value="{{ old('oku_status') }}" placeholder="Jika ada">
                                            </div>
                                        </div>
                                        <div class="col-12">
                                            <div class="rbt-form-group">
                                    ...
                                    <div class="row row--15">
                                        <div class="col-lg-6">
                                            <div class="rbt-form-group">
                                                ...
                                                <input id="registration_no" name="registration_no" type="text" value="{{ old('registration_no') }}">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="rbt-form-group">
                                                ...
                                                <input id="session_year" name="session_year" type="text" value="{{ old('session_year') }}" placeholder="Contoh: 2024/2025">
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                                            <div class="rbt-form-group">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="rbt-form-group">
                                                ...
                                                <input id="entry_date" name="entry_date" type="date" value="{{ old('entry_date') }}">
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                                            <div class="rbt-form-group">
                                                <label for="origin_school">SK / Sekolah Asal</label>
                                                <input id="origin_school" name="origin_school" type="text" value="{{ old('origin_school') }}">
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                                            <div class="rbt-form-group">
                                                <label for="upkk_number">Angka Giliran UPKK</label>
                                                <input id="upkk_number" name="upkk_number" type="text" value="{{ old('upkk_number') }}">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row row--15">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="rbt-form-group">
                                                ...
                                                <input id="father_ic" name="father_ic" type="text" value="{{ old('father_ic') }}">
                                            </div>
                                        </div>
                                        <div class="col-lg-4">
                                            <div class="rbt-form-group">
                                        ...
                                        <div class="col-lg-4">
                                            <div class="rbt-form-group">
                                                ...
                                                <input id="father_job" name="father_job" type="text" value="{{ old('father_job') }}">
                                            </div>
                                        </div>
                                        <div class="col-lg-4">
                                            <div class="rbt-form-group">
                                                <label for="father_income">Pendapatan (RM)</label>
                                                <input id="father_income" name="father_income" type="number" step="0.01" value="{{ old('father_income') }}">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="rbt-form-group">
                                                ...
                                                <input id="mother_ic" name="mother_ic" type="text" value="{{ old('mother_ic') }}">
                                            </div>
                                        </div>
                                        <div class="col-lg-4">
                                            <div class="rbt-form-group">
                                        ...
                                        <div class="col-lg-4">
                                            <div class="rbt-form-group">
                                                ...
                                                <input id="mother_job" name="mother_job" type="text" value="{{ old('mother_job') }}">
                                            </div>
                                        </div>
                                        <div class="col-lg-4">
                                            <div class="rbt-form-group">
                                                <label for="mother_income">Pendapatan (RM)</label>
                                                <input id="mother_income" name="mother_income" type="number" step="0.01" value="{{ old('mother_income') }}">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="rbt-form-group">
                                                ...
                                                <input id="dependents_count" name="dependents_count" type="number" value="{{ old('dependents_count') }}">
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                                            <div class="rbt-form-group">
                                                <label for="parents_relationship_status">Status Hubungan</label>
                                                <input id="parents_relationship_status" name="parents_relationship_status" type="text" value="{{ old('parents_relationship_status') }}" placeholder="Contoh: Berkahwin, Duda, Ibu Tunggal">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="mt--30 d-flex justify-content-between">
                                    ...
                                    <div class="row row--15">
                                        <div class="col-12">
                                            <div class="rbt-form-group">
                                                ...
                                                <textarea id="chronic_disease" name="chronic_disease" rows="2" placeholder="Nyatakan jika ada">{{ old('chronic_disease') }}</textarea>
                                            </div>
                                        </div>
                                        <div class="col-12">
                                            <div class="rbt-form-group">
                                                <label for="allergies">Alahan</label>
                                                <textarea id="allergies" name="allergies" rows="2" placeholder="Nyatakan jika ada">{{ old('allergies') }}</textarea>
                                            </div>
                                        </div>
                                        <div class="col-12">
                                            <div class="rbt-form-group">
                                                <label for="emergency_contact">Kenalan Kecemasan</label>
                                                <textarea id="emergency_contact" name="emergency_contact" rows="2" placeholder="Nama & No. Telefon">{{ old('emergency_contact') }}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="mt--30 d-flex justify-content-between">
                                        <button type="button" class="rbt-btn btn-secondary btn-prev"><i class="feather-arrow-left"></i> Kembali</button>
                                        <button type="submit" class="rbt-btn btn-success">Simpan Rekod <i class="feather-check"></i></button>
                                    </div>
                                </div>
                            </div>
                        </form>
        ...
        function initWizard() {
            ...
            if (schoolSelect && classSelect) {
                schoolSelect.addEventListener('change', function() {
                    ...
                    fetch(`{{ url('get-teachers-by-school') }}/${schoolId}`)
                        .then(response => response.json())
                        .then(data => {
                            // Nota: Kita gunakan endpoint sedia ada tetapi panggil controller KafaClass
                            // Sila pastikan route get-teachers-by-school dipetakan ke KafaClassController@getClassesBySchool
                        })
                        .catch(err => console.error('Error fetching classes:', err));
                    
                    // Kita perlukan endpoint khusus untuk Kelas. Jom kita semak route dlu atau bina satu.
                    // Buat sementara, saya akan panggil endpoint /get-classes/${schoolId}
