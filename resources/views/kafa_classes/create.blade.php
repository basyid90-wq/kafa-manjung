                ...
                <div class="rbt-dashboard-content bg-color-white rbt-shadow-box" style="overflow: visible !important;">
                    <div class="content" style="padding-top: 50px !important;">
                        <div class="section-title">
                            <h4 class="rbt-title-style-3">Tambah Kelas Baru</h4>
                        </div>

                        <form action="{{ route('kafa_classes.store') }}" method="POST" class="rbt-profile-row rbt-default-form row row--15">
                            @csrf
                            ...
                            <div class="col-lg-5 col-md-8 col-12">
                                <div class="rbt-form-group">
                                    ...
                                    <input id="name" name="name" type="text" value="{{ old('name') }}" placeholder="Contoh: ABU BAKAR AS SIDDIQ" required>
